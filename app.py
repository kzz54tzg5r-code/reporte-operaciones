...
def get_operational_data():
    data = [
        # SEMANA 21 DETALLADA (POR DÍA Y TIENDA)
        ...
        {"Mes": "Mayo", "Semana": "Semana 21", "Fecha": "2026-05-30", "Tienda": "Vallejo", "Sis_Aduana": 513, "Fis_Aduana": 400, "Muertos": 68, "Cajas": 363, "Meta_Rec": 8, "Real_Rec": 4, "Recolectadas": 431, "Habilitadas": 624, "Ubicadas": 611},
    ...
    # Mapeo estructurado de días de la semana en español
...
if not df_filtered.empty:
    ...
    with col_g1:
        # Gráfico 1: Mezcla de Ingresos (Aduana, Muertos, Cajas)
        ...
        fig1.update_layout(title=f"Distribución y % de Composición de Ingresos", barmode='stack', barnorm='percent', plot_bgcolor='white', margin=dict(t=40, b=20, l=20, r=20))
        st.plotly_chart(fig1, use_container_width=True)

    with col_g2:
        # Gráfico 2: Eficiencia de Habilitado vs Volumen de Entrada
        ...
        fig2.update_layout(title_text=f"Rendimiento: % Habilitado vs Volumen", plot_bgcolor='white', margin=dict(t=40, b=20, l=20, r=20))
