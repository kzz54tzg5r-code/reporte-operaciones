...
# Estilos corporativos globales (Incluye Azul Énfasis 1 Oscuro al 25%)
st.markdown("""
    <style>
...
def get_operational_data():
    data = [
        ...
        {"Mes": "Mayo", "Semana": "Semana 21", "Fecha": "2026-05-29", "Tienda": "Puebla Sur", "Sis_Aduana": 160, "Fis_Aduana": 152, "Muertos": 39, "Cajas": 0, "Meta_Rec": 5,
