...
# -------------------------------------------------------------------------
# TAB 2: EVOLUCIÓN INTERSEMANAL (ESTRUCTURA HTML SÓLIDA)
# -------------------------------------------------------------------------
with tab_evolutivo:
    ...
    # Estructura del contenedor HTML inicializado correctamente (Evita pantallas en blanco)
    html_comparativo = """
    ...
    # Despliegue seguro de la tabla sin romper el árbol del DOM
    st.markdown(
