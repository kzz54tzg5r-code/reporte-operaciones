...
st.markdown('<p class="sub-title">CONTROL DE CAMBIOS Y MUERTOS</p>', unsafe_allow_html=True)
st.markdown("<hr style='border: 0; height: 1px; background: #D9D9D9; margin-top:5px; margin-bottom:15px;'>", unsafe_allow_html=True)

# --- PANEL DE CONTROL (BARRA LATERAL CON FILTRO EXPANSIBLE) ---
...
if not df_filtered.empty:
    ...
    # =========================================================================
    # --- RESUMEN SUPERIOR: DESGLOSE DE 4 SEMANAS CON PORCENTAJES EN LÍNEA ---
    # =========================================================================
    ...
    # =========================================================================
    # --- SECCIÓN 2: MATRIZ GRÁFICA PARALELA ---
    # =========================================================================
    ...
    # Determinar el eje de tiempo paramétrico según el filtro seleccionado
    ...
    with col_g1:
        # --- PRIMER GRÁFICO: CONSTRUIDO CON TRAZOS EXPLÍCITOS EN GRAPH_OBJECTS ---
        ...
        # Creamos una figura go vacía para tener el control absoluto de barnorm sin usar px
        fig1 = go.Figure()
        
        # Añadimos los componentes uno a uno
        ...
        # Configuramos el diseño para que las barras se apilen y se transformen a porcentaje de forma nativa
        fig1.update_layout(
